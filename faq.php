...
<?php include('menues/navusuario.php') ?>

	<header id="gtco-header" class="gtco-cover gtco-cover-sm" role="banner" style="background-color:gray;">
  ...
  <div class="modal fade" id="login" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="container">
		<div class="row">
			<div class="col-6 offset-4 mt-5 bg-faded">
				<form action="#" method="post">
					<h3>Inicia Sesion</h3>

					<div class="form-group">
						<input type="text" name="usuario" class="form-control-sm" required="required" placeholder="Usuario" autofocus required></input>
					</div>

					<div class="form-group">
						<input type="password" name="clave" class="form-control-sm" required="required" placeholder="Password" required></input>
					</div>

					<div class="form-group">
						<input type="submit" class="btn btn-info" title="Iniciar sesion" name="login" value="Entrar"></input>
					</div>
				</form>
				<div class="form-group">
...
include('dbcon.php');
		if (isset($_POST['login']))
		{
			...
			$query 		= mysqli_query($con, "SELECT * FROM usuario WHERE  clave='".$password."' and usuario='".$username."'");
...
<div class="col-sm-6">
    ...
    Ingrese name(usuario)
    <input class="form-control" type="text" name="usuario"><br>
    Ingrese nombrecompleto
    <input class="form-control" type="text" name="nombrecompleto"><br>
        Ingrese DNI
